...
public class DBManager {
    ...
    public static void createStudent(String surname, String name, int idGroup, String date) {
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection(
                    Constants.CONNECTION_URL);
            Statement stmt = conn.createStatement();
            stmt.execute("INSERT INTO `student` (`surname`, `name`, `id_group`, `date`) "
                    + "VALUES ('" + surname + "', '" + name + "', '" + idGroup + "', '" + date + "');");
    ...
    public static void modifyStudent(String id, String surname, String name, int idGroup, String date) {
        ...
        try {
            ...
            stmt.execute("UPDATE `student` SET `surname` = '" + surname + "', `name` = '"
                    + name + "', `id_group` = '" + idGroup + "', `date` = '" + date + "' WHERE (`id` = '" + id + "');");
    ...
    ///  ЕЩЕ так же ПРИГОДИТСЯ для Вкладки дисциплина
    ...
    public static void createTerm(String name, String duration, String[] disciplines) {
        ...
        try {
            ...
            Statement stmt = conn.createStatement();
            stmt.execute(
                    "INSERT INTO `term` (`term`, `duration`) VALUES ('" + name + "', '" + duration + "');");
            ...
            for (String idDisc : disciplines) {
                stmt.execute(
                        "INSERT INTO `term_discipline` (`id_term`, `id_discipline`) " +
                                "VALUES ('" + idTerm + "', '" + idDisc + "');");
    ...
    public static void modifyTerm(String id, String duration, String[] disciplines) {
        ...
        try {
            ...
            Statement stmt = conn.createStatement();
            stmt.execute(
                    "UPDATE `term` SET `duration` = '" + duration + "' WHERE (`id` = '" + id + "');");

            stmt.execute(
                    "DELETE FROM `term_discipline` WHERE (`id_term` = '" + id + "');");
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery(
                    "SELECT * FROM user_role as ur\n" +
                            ...
                            "where ur.id_role = '" + role
                            + "' and u.user = '" + login + "' and u.password = '" + password + "'");
