...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/fonts/fonts.css?v=232">
...
<div id="container">
    ...
    <main>
        <section class="content">
            ...
            <div class="main">
                <h2>Для модикации введите новые значения и нажмите "Применить".</h2>
                <div class="form_cm">
