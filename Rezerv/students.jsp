...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/fonts/fonts.css?v=232"/>">
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/style.css?v=232"/>">
</head>
<body>
<div id="container">
    <header>
        ...
        <section class="content">
            ...
            <div class="main">
                <div class="button_group1">
                    ...
                    <form action="${pageContext.request.contextPath}/student-create" method="get">
                ...
                <div class="students">
                    <table class="list">
                        ...
                        <c:forEach items="${students}" var="s">
                            <tr>
                                <td class="l_col0"><label><input name="idStudent" type="checkbox" value="1"></label>
                                </td>
